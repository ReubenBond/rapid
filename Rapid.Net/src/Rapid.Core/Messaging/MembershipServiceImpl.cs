...
{
    public override async Task<RapidResponse> SendRequest(RapidRequest request, ServerCallContext context) => await handler.HandleMessageAsync(request, context.CancellationToken).ConfigureAwait(true);
}
